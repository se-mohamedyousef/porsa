import { kvDev } from "./kv-dev.js";

// In development mode, always use the dev store
// This avoids trying to connect to Vercel KV during development
const isDevMode = process.env.NODE_ENV === "development";

// In dev mode, use kvDev
// In production, this will be handled by other means or the module will remain as kvDev
let kvStore = kvDev;

if (isDevMode) {
  console.log("[KV] Using development in-memory store");
} else {
  // In production, we might try to load the real Vercel KV
  // but for now, keep it simple and use kvDev everywhere
  console.log("[KV] Using development store (or will use Vercel KV if configured)");
}
